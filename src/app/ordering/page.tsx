      ...
      >
        ...
        <div className="space-y-3 mb-6 mt-4">
          <div className="relative">
            <select className="w-full h-[40px] text-xs text-text-secondary pl-4 pr-2 border border-border-default rounded-lg appearance-none bg-white">
        ...
        <div className="border border-border-default rounded-lg p-3 mb-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-[22px]">
              <button onClick={() => {console.log('minus');
        ...
        <div className="flex space-x-2">
          <div className="relative group flex-1">
            <button  className="w-full py-4 border border-gradient-primary rounded-lg font-medium transition-colors">
              정기구독
            </button>
          ...
          {/*  how can i give that linear gradient to the button */}
          <button className="flex-1 py-4 border border-transparent bg-linear-gradient text-white rounded-lg font-medium  transition-colors">
            단품 구매
          </button>
        </div>
      </ActionSheet>
