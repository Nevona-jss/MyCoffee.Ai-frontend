        ...
        <div className="p-4 text-gray-0 flex flex-col h-full">
            ...
            <div className="flex items-center gap-2 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    <path d="M13.9999 2.33398L17.6049 9.63732L25.6666 10.8157L19.8333 16.4973L21.2099 24.524L13.9999 20.7323L6.78992 24.524L8.16658 16.4973L2.33325 10.8157L10.3949 9.63732L13.9999 2.33398Z" fill="#FFC107" stroke="#FFC107" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                    <path d="M13.9999 2.33398L17.6049 9.63732L25.6666 10.8157L19.8333 16.4973L21.2099 24.524L13.9999 20.7323L6.78992 24.524L8.16658 16.4973L2.33325 10.8157L10.3949 9.63732L13.9999 2.33398Z" fill="#FFC107" stroke="#FFC107" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            ...
            <textarea
                ...
                className="mb-4 bg-transparent placeholder:text-[#6E6E6E] placeholder:font-normal font-bold border border-[#E6E6E6] text-gray-0 text-[12px] rounded-lg focus:outline-none focus:ring-[#FF7939] focus:border-[#FF7939] block w-full py-2.5 px-4"
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <g clip-path="url(#clip0_1714_6533)">
                                                <path d="M8.00016 14.6673C11.6821 14.6673 14.6668 11.6825 14.6668 8.00065C14.6668 4.31875 11.6821 1.33398 8.00016 1.33398C4.31826 1.33398 1.3335 4.31875 1.3335 8.00065C1.3335 11.6825 4.31826 14.6673 8.00016 14.6673Z" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M10 6L6 10" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M6 6L10 10" stroke="white" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                            </g>
                                            <defs>
            ...
            <button
                className={`w-full mt-auto ${textareaValue.trim()
                    ? 'btn-primary'
                    : 'btn-primary-empty bg-action-disabled text-text-disabled !cursor-not-allowed'
                    }`}
