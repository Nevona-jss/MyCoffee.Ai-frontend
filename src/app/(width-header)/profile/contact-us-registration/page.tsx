    ...
    return (
        <div className="p-4 text-gray-0 flex flex-col h-full">
            ...
            <div className="border border-border-default rounded-2xl p-3 bg-white mb-4">
                <span className="text-xs w-max font-bold bg-[#17A2B8] text-white px-2 py-1 mb-3 rounded-sm h-[24px] flex items-center justify-center">
                    단품
                </span>
            ...
            >
                <div className="text-center">
                    <div className="flex flex-col gap-2">
                        <p className="text-base font-bold leading-[20px] my-6">
                            문의를 등록하시겠습니까?
                        </p>
                        <button
