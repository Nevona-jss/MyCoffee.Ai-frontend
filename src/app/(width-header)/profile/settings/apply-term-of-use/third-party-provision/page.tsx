    ...
    <div className="p-4">
      <div className="bg-white rounded-2xl border border-border-default p-3">
        ...
        <section className="mb-4">
          ...
          <ol className="space-y-1 text-[10px] leading-[16px] pl-4 list-disc">
            <li>고객님의 결제 및 주문 처리와 관련하여 아래와 같이 개인정보가 제3자(결제 대행사)에게 제공됩니다.</li>
            <li>제공받는 자: 토스페이먼츠 주식회사</li>
            <li>
            제공 목적: 결제 승인, 결제 처리, 환불 처리
            </li>
            <li>제공 항목: 이름, 휴대전화번호, 이메일, 결제 정보(카드사명, 승인번호 등)</li>
            <li>보유 및 이용 기간: 관련 법령에 따른 의무 보관기간 동안 보유 후 파기</li>
            <li>당사는 원활한 결제 및 환불 처리 이외의 목적으로 개인정보를 제공하지 않습니다.</li>
          </ol>
        </section>
        ...
        <section className="mb-4">
          ...
          <ol className="space-y-1 text-[10px] leading-[16px] pl-4 list-disc">
            <li>문의 접수: 아로마빌 고객센터 (전화: 070-7721-8181 / 이메일: aromaville@aromaville.co.kr)</li>
