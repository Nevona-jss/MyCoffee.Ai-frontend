          ...
          {coffeeAnalyses.map((analysis) => (
            <div key={analysis.id} className="bg-white rounded-2xl px-4 py-3 border border-border-default">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <button onClick={() => openModal(analysis)} className="cursor-pointer size-8 border border-action-primary rounded-sm flex items-center justify-center">
      ...
      >
        <div>
          ...
          <button onClick={() => setDeleteModalIsOpen(true)} className="w-full btn-primary-empty border border-action-primary !py-[11px] text-action-primary text-center flex items-center justify-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
              <path d="M16.3337 5V16.6667C16.3337 17.1087 16.1581 17.5326 15.8455 17.8452C15.5329 18.1577 15.109 18.3333 14.667 18.3333H6.33366C5.89163 18.3333 5.46771 18.1577 5.15515 17.8452C4.84259 17.5326 4.66699 17.1087 4.66699 16.6667V5" stroke="#4E2A18" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M3 5H18" stroke="#4E2A18" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M7.16699 4.99984V3.33317C7.16699 2.89114 7.34259 2.46722 7.65515 2.15466C7.96771 1.8421 8.39163 1.6665 8.83366 1.6665H12.167C12.609 1.6665 13.0329 1.8421 13.3455 2.15466C13.6581 2.46722 13.8337 2.89114 13.8337 3.33317V4.99984" stroke="#4E2A18" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            삭제
          </button>
        </div>
