...
const CollectionDetail = () => {
    ...
    return (
        <div className="pl-4 pt-6 pb-2">
            <div className="pr-4">
                <h2 className="text-[20px] font-bold text-gray-0 mb-2 text-center">나만의 커피 1호기</h2>
                <p className="text-[10px] text-text-secondary mb-2 text-center font-normal">2025-08-24 오후 12:34</p>
                <p className="text-xs text-gray-0 mb-6 text-center font-normal">달달한 커피가 먹고 싶을 때 추천받은 커피</p>
                                    ...
                                    {item.id === 0 ? (
                                        <div className="border border-border-default rounded-2xl p-3 bg-white mr-4">
                                            ...
                                            <div className="text-center mb-4">
                                                <p className="text-xs text-gray-0 leading-[18px]">
                                                    (브라질 42%, 페루 58%)
                                                </p>
                                            </div>
            ...
            <div className="flex justify-center gap-2 pr-4 mt-9">
                ...
                <OrderingComponent title={"주문하기"} isTooltipOpenHave={true}   />
            </div>
