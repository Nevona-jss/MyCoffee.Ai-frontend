          ...
          <div className="flex gap-1">
            <div className="flex-1">
              <input
                type="tel"
                id="phone"
                className={`w-full bg-transparent placeholder:text-[#6E6E6E] placeholder:font-normal font-bold border text-gray-0 text-sm rounded-lg focus:outline-none focus:ring-[#FF7939] focus:border-[#FF7939] px-4 py-[9px] ${errors.phone ? 'border-[#EF4444]' : 'border-[#E6E6E6]'
                  }`}
        ...
        <div className="pt-4">
          ...
          <div className="flex gap-1">
            <input
              type="text"
              id="verificationCode"
              className={`w-full bg-transparent placeholder:text-[#6E6E6E] placeholder:font-normal font-bold border text-gray-0 text-sm rounded-lg focus:outline-none focus:ring-[#FF7939] focus:border-[#FF7939] px-4 py-[9px] ${errors.verificationCode ? 'border-[#EF4444]' : 'border-[#E6E6E6]'
                }`}
