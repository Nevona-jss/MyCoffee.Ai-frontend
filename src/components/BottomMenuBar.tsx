...
const homeIcon = (fill: string = '#B3B3B3') => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <g clip-path="url(#clip0_1784_5452)">
        <path d="M7.71432 0.857422H2.57146C1.62469 0.857422 0.857178 1.62493 0.857178 2.57171V7.71456C0.857178 8.66134 1.62469 9.42885 2.57146 9.42885H7.71432C8.66109 9.42885 9.42861 8.66134 9.42861 7.71456V2.57171C9.42861 1.62493 8.66109 0.857422 7.71432 0.857422Z" stroke="#B3B3B3" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M21.4287 0.857422H16.2858C15.339 0.857422 14.5715 1.62493 14.5715 2.57171V7.71456C14.5715 8.66134 15.339 9.42885 16.2858 9.42885H21.4287C22.3754 9.42885 23.143 8.66134 23.143 7.71456V2.57171C23.143 1.62493 22.3754 0.857422 21.4287 0.857422Z" stroke="#B3B3B3" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M7.71432 14.5723H2.57146C1.62469 14.5723 0.857178 15.3398 0.857178 16.2866V21.4294C0.857178 22.3762 1.62469 23.1437 2.57146 23.1437H7.71432C8.66109 23.1437 9.42861 22.3762 9.42861 21.4294V16.2866C9.42861 15.3398 8.66109 14.5723 7.71432 14.5723Z" stroke="#B3B3B3" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M21.4287 14.5723H16.2858C15.339 14.5723 14.5715 15.3398 14.5715 16.2866V21.4294C14.5715 22.3762 15.339 23.1437 16.2858 23.1437H21.4287C22.3754 23.1437 23.143 22.3762 23.143 21.4294V16.2866C23.143 15.3398 22.3754 14.5723 21.4287 14.5723Z" stroke="#B3B3B3" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
    </g>
    <defs>
...
const globalIcon = (fill: string = '#B3B3B3') => <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none">
    <path d="M11 21.5C16.5228 21.5 21 17.0228 21 11.5C21 5.97715 16.5228 1.5 11 1.5C5.47715 1.5 1 5.97715 1 11.5C1 17.0228 5.47715 21.5 11 21.5Z" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M1 11.5H21" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14.8456 11.5C14.6567 15.1569 13.3098 18.659 10.9995 21.5C8.6892 18.659 7.34224 15.1569 7.15332 11.5C7.34224 7.84309 8.6892 4.341 10.9995 1.5C13.3098 4.341 14.6567 7.84309 14.8456 11.5V11.5Z" stroke={fill} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
</svg>
...
const BottomMenuBar = () => {
    return (
        <div className="h-[112px] mt-auto navbar-menu">
            <div className="bg-[#fff] fixed bottom-0 w-full sm:max-w-sm rounded-t-[6px] px-2 z-10 -mt-4 pb-2" style={{ boxShadow: "0 -1px 2px 0 rgba(0,0,0,0.04)" }}>
                <div className="flex items-center justify-between">
                    {/* Home */}
                    <div className="px-3 py-2.5 flex flex-col items-center cursor-pointer">
                        {homeIcon("#4E2A18")}
                        <span className="text-[12px] text-primary mt-2">홈</span>
                    </div>

                    {/* edit */}
                    <div className="px-3 py-2.5 flex flex-col items-center cursor-pointer">
                        {editIcon()}
                        <span className="text-[12px] text-[#999] mt-2">리뷰</span>
                    </div>

                    <div className='navbar-menu-main-item-wrapper relative shrink-0 flex-col items-center justify-center -translate-y-[36%] rounded-full'>
                    ...
                    <div className="px-3 py-2.5 flex flex-col items-center cursor-pointer">
                        {globalIcon()}
                        <span className="text-[12px] text-[#999] mt-2">커뮤니티</span>
                    </div>

                    {/* Profile */}
                    <div className="px-3 py-2.5 flex flex-col items-center cursor-pointer">
                        {profileIcon()}
                        <span className="text-[12px] text-[#999] mt-2">MY</span>
                    </div>
                </div>
            </div>
        </div>
